...
g = Graph(10)
A = g.insert_vertex('Cherprang')
B = g.insert_vertex('Jane')
C = g.insert_vertex('Kaew')
D = g.insert_vertex('Jennis')
E = g.insert_vertex('Pan')


ab = g.insert_edge(A,B,8)
ac = g.insert_edge(A,C,15)
ad = g.insert_edge(A,D,14)
ae = g.insert_edge(A,E,5)
bc = g.insert_edge(B,C,7)
bd = g.insert_edge(B,D,22)
be = g.insert_edge(B,E,12)
cd = g.insert_edge(C,D,8)
ce = g.insert_edge(C,E,10)
de = g.insert_edge(D,E,9)


print("Dijkstra :", Dijkstra(g,A))
print("Dijkstra :", Dijkstra(g,B))
print("Dijkstra :", Dijkstra(g,C))
print("Dijkstra :", Dijkstra(g,D))
print("Dijkstra :", Dijkstra(g,E))

#print("PrimJarnik :", PrimJarnik(g))

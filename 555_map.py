...
with open('student.csv','r',encoding="utf-8-sig") as f:
    ...
    for row in studentlist:
        STD.__setitem__(row[0],row[1])
        CHM.__setitem__(row[0],row[1])
...
elapsed_CHM = end - start
value =  CHM.__getitem__(key)
print("Time TableMap:", elapsed_STD)
print("Time ChainHashMap:", elapsed_CHM)
print(key,":", value)

...
#-------------------------------------------------------------------------        
    ...
    def remove_edge(self,e):
        ref = e.endpoints()
        self._MATRIX[self.findindex(ref[0]),self.findindex(ref[1])] = None
        self._MATRIX[self.findindex(ref[1]),self.findindex(ref[0])] = None

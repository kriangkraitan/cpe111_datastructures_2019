...
class LStack :
    ...
    def push( self, item ):
        new_node = ListNode(item) # create a new node
        new_node._next = self._head # link the new node to the 'previous' node.
        self._head = new_node #  set the current node to the new one.
        self._size+=1
